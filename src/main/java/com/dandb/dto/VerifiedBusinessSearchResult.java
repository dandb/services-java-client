...
public class VerifiedBusinessSearchResult {
	...
	public static VerifiedBusinessSearchResult init(){
		VerifiedBusinessSearchResult businessSearchResult = new VerifiedBusinessSearchResult();
		businessSearchResult.business_id = VerifiedBusinessSearchResult.randomBigInt(BigInteger.valueOf(10000000));
